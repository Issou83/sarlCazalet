    ...
    <div>
      <p>
        ...
        <p>
          ...
          comme le cas échéant l'accés à votre compte personnel, ou encore de
          ...
          lecture de votre terminal ils peuvent inclure des cookies de réseaux
          sociaux lorsque vous interagissez avec ces derniers. Ils nous
          permettent aussi de lier entre elles les différentes pages consultées
          pour vous assurer une navigation fluide <br />
          Pour paramétrer, vous pouvez désactiver complètement les cookies dans
          votre navigateur. Dans ce cas notre site ne fonctionnera plus
          normalement mais vous pourrez quand même effectuer des actionsbasiques
        </p>
      </p>
      <ul>
        <li>
          1/ Si vous utilisez le navigateur Internet Explorer Dans Internet
          Explorer, cliquez sur le bouton Outils, puis sur «Options Internet». -
        ...
        <li>
          2/ Si vous utilisez le navigateur Firefox - Allez dans le menu Outils
          du navigateur puis sélectionnez le menu Options - Cliquez sur l'onglet
          evie privée, décocher la case Accepter les cookies puis cliquez sur OK
        </li>
        <li>
          3/ Si vous utilisez le navigateur Safari - Dans votre navigateur, cho
          aissez le menu Edition - puis selectionnez Préférences - Cliquez sur
          Confidentialité. - Positionnez le réglage Bioquer les cookies sur
          Toujours puis cliquez sur OK
        </li>
        <li>
          4/ Si vous utilisez le navigateur Google Chrome - Cliquez sur le menu
          Chrome dans la barre d'outils du navigateur - Sélectionnez Paramètres
          - Cliquez sur Afficher les paramètres avances - Dans la section
